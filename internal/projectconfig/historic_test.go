...
func writeWorktreeFile(t *testing.T, fs billy.Filesystem, relPath, content string) {
	t.Helper()
...
func TestLoadProjectConfigAtCommit(t *testing.T) {
	...
	writeWorktreeFile(t, bfs, "azldev.toml", `
[components.foo]
...
func TestResolveComponentOverlaysAtCommit_MissingComponent(t *testing.T) {
	...
	writeWorktreeFile(t, bfs, "azldev.toml", "[components.foo]\n")
