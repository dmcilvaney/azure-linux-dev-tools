...
func (p *sourcePreparerImpl) trySyntheticHistory(
	...
	if err := CommitInterleavedHistory(
		...
		replaceRelease, replaceChangelog, config.Autospec.TruncateUpstreamHistory,
	); err != nil {
...
func computeCurrentFingerprint(
	...
	slog.Debug("computeCurrentFingerprint result",
		...
		"autospec.release-calculation", config.Autospec.ReleaseCalculation,
		"autospec.changelog-calculation", config.Autospec.ChangelogCalculation,
	)
